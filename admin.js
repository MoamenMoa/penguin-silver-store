...
const PRODUCT_FIELDS=['nameAr','nameEn','descAr','descEn','price','oldPrice','category','image','images','featured','isNew','onSale','active','stock','sku','material','karat','sizes','weight','createdAt','updatedAt','showOnHome','ratingEnabled','ratingStars','ratingText','colors'];
